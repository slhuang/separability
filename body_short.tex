...
Given a feature-object matrix and positive (green) and negative class (red) labels on the objects (left panel of Figure~\ref{fig:workflow}), \genviz evaluates all pairs of features using several optimizations to identify the top feature pair(s) and its corresponding visualization that best separates the object classes (right panel of Figure~\ref{fig:workflow}).}
\label{fig:workflow}
\vspace{-15pt}
\end{figure*}
