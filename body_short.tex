...
statistical and machine learning tools to identify a manageable subset of features, e.g. genes, 
...
\stitle{\new{Challenge 1: Explainable Separation with Guarantees.} }
...
on feature pairs offer the advantage of providing more  \new{interpretable or explainable results} over
...
papers~\cite{shen2017identification, basu2018iterative, shah2014random,
schwarz2010safari} employ these more complex machine learning approaches 
...
\stitle{\new{Challenge 2: Scalability in Data Size.} }
...
\stitle{\new{A Scalable and Explainable Tool for Addressing Separability: \genviz.}} Motivated by these observations, we present \genviz, an interactive data
...
complex and longer to train machine learning approaches. \genviz is also based
