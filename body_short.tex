...
that accentuate or explain the differences between classes \new{---a problem we
refer to as the {\em separability problem}.}
...
more complex machine learning approaches that return several features to
...
to heuristically return more interpretable feature pairs. However, as a result
of this heuristic, these methods do not fully explore the search space nor offer
...
al.~\cite{watkinson2008identification}, synergy is
proposed for evaluating the utility of feature pairs. Metrics like synergy aim
...
quantifying linear separability, on the other hand, may return a more limited
subset of interesting features, but they also may be more intuitive for users to 
understand and enable more performance optimizations and speedups. The linear
...
complex, longer to train machine learning approaches. \genviz is also based 
