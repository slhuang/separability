...
\genviz is available as a web-based tool at \url{http://128.174.244.49:5000}
\cb{move to permanent/accessible location/domain}\silu{seems like this can only be accessed via campus network..} and is open-sourced at \url{https://github.com/KnowEnG/Genvisage}.
\silu{add screenshot}
