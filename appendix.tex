...
For our knowledge bases of protein and gene interactions, we downloaded datasets derived from 8 data sources: STRING~\citeapp{szklarczyk2014string}, Reactome~\citeapp{croft2013reactome}, Pathway Commons~\citeapp{cerami2010pathway}, HumanNet~\citeapp{lee2011prioritizing}, BioGRID~\citeapp{chatr2017biogrid}, Intact~\citeapp{orchard2013mintact}, DIP~\citeapp{salwinski2004database}, and BLAST databases. The datasets were downloaded, harmonized, and mapped to Ensembl gene identifiers using the KnowEnG Knowledge Network Builder \url{https://github.com/KnowEnG/KN_Builder}. The final processed network used in this work can be downloaded from \url{https://github.com/KnowEnG/KN_Fetcher/blob/master/Contents.md#gene}.
